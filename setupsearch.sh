...
#hadoop jar $CLOUDERA_SEARCH_MR_PATH org.apache.solr.hadoop.MapReduceIndexerTool -D 'mapred.child.java.opts=-Xmx500m' --log4j $PROJECT_HOME/log4j.properties --morphline-file $BASE_DIR/nflmorphlines.conf --output-dir hdfs:/user/cloudera/nflsearchdata/ --verbose --go-live --zk-host $SOLR_ZK_ENSEMBLE --collection NFL-Collection hdfs:/user/hive/warehouse/playbyplay/
